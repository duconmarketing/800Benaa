 ...
 */
 Route::register(
    '/product/ajax/controller/filter', 
    'Application\Controller\ProductService::filter'
);
Route::register(
    '/product/ajax/controller/bestseller', 
    'Application\Controller\ProductService::bestseller'
);
Route::register(
    '/product/ajax/controller/brand', 
    'Application\Controller\ProductService::brand'
);
Route::register(
    '/product/ajax/controller/loadmore', 
    'Application\Controller\ProductService::loadMore'
);
Route::register(
    '/product/ajax/get/template', 
    'Application\Controller\ProductService::template'
);

Route::register(
    '/api/get/key', 
    'Application\Controller\ProductUpdate::getDetails'
);
Route::register('/api/get/token', '\Application\Controller\ProductUpdate::startHandshake');
//Route::register('/api/add/product', '\Application\Controller\ProductUpdate::postBlog');
Route::register('/api/edit/product', '\Application\Controller\ProductUpdate::editProduct');

use \Concrete\Core\Asset\AssetList;
use \Concrete\Core\Asset\Asset;

$al = AssetList::getInstance();
$al->register('javascript', 'build', 'themes/build/js/build.js',array('version' => '2.0', 'position' => Asset::ASSET_POSITION_FOOTER, 'minify' => false, 'combine' => false));
