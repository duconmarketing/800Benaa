...
<?php if ($cart) { ?>
    ...
    <table nobr="true" class="style1" style="margin-bottom:25px;">
        <tbody>
            <tr>
                    <td colspan="5" align="right" ><strong class="cart-grand-total-label"><b><?= t("Sub Total") ?>:</b></strong></td>
                    <td  align="right"><?php
                        ...
                        ?>
                            ...
                            ?>
                                    <tr>
                    <td colspan="5" align="right" ><strong class="cart-grand-total-label"><b><?= t("Shipping Charge") ?>:</b></strong></td>
                    <td  align="right"><?php
                        ...
                        ?>
                            ...
                            ?>
                            <tr>
                    <td colspan="5" align="right" ><strong class="cart-grand-total-label"><b><?= t("TAX (5%)") ?>:</b></strong></td>
                    <td  align="right"><?php
                ...
                <tr>
                    <td colspan="5" align="right" ><strong class="cart-grand-total-label"><b><?= t("Grand Total") ?>:</b></strong></td>
                    <td  align="right"><?php
