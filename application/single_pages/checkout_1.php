...
<!--                                 <div class="form-group">
                               ...
                               <div class="form-group">
                                    <label for="store-checkout-billing-state"><?= t("Region *") ?></label>
                        ...
                        <?php if ($orderChoicesEnabled) { ?>
                            <div id="store-checkout-form-group-other-attributes" class="store-checkout-form-group <?= isset($paymentErrors) ? 'store-checkout-form-group-complete' : '';?>">
                                ...
                                <div class="">
                                    ...
                                    <h5 style="text-align: center; color: #ec7c05;"><?= t("(For Companies Only)") ?></h5>
...
<!--                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="store-checkout-shipping-state"><?= t("Region *") ?></label>
