                    ...
                    <div class="store-checkout-form-group-body">
                        ...
                        if ($enabledPaymentMethods) {
                            ...
                            foreach ($enabledPaymentMethods as $pm) {
                                ...
                                <input type="submit" class="store-btn-complete-order btn btn-default pull-right" id="store-btn-complete-order2" value="<?= $pm->getButtonLabel()? $pm->getButtonLabel() : t("Confirm Order") ?>">
