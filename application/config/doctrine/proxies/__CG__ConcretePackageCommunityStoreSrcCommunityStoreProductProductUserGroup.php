 ...
 */
class ProductUserGroup extends \Concrete\Package\CommunityStore\Src\CommunityStore\Product\ProductUserGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'pugID', 'pID', 'product', 'gID');
        }
