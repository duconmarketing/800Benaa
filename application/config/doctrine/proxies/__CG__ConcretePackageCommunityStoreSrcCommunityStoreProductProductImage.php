 ...
 */
class ProductImage extends \Concrete\Package\CommunityStore\Src\CommunityStore\Product\ProductImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'piID', 'pID', 'product', 'pifID', 'piSort');
        }
