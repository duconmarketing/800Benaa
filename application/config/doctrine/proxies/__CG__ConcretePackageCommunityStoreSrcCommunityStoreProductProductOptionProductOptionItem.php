...
class ProductOptionItem extends \Concrete\Package\CommunityStore\Src\CommunityStore\Product\ProductOption\ProductOptionItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'poiID', 'poID', 'option', 'poiName', 'poiSort', 'poiHidden', '' . "\0" . 'Concrete\\Package\\CommunityStore\\Src\\CommunityStore\\Product\\ProductOption\\ProductOptionItem' . "\0" . 'variationoptionitems');
        }
    ...
    public function update($name, $sort, $hidden = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'update', array($name, $sort, $hidden));

        return parent::update($name, $sort, $hidden);
    }
