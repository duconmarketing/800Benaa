...
class OrderItem extends \Concrete\Package\CommunityStore\Src\CommunityStore\Order\OrderItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'oiID', 'pID', 'order', 'oiProductName', 'oiSKU', 'oiPricePaid', 'oiTax', 'oiTaxIncluded', 'oiTaxName', 'oiQty');
        }
    ...
    public function getProductObject()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProductObject', array());
