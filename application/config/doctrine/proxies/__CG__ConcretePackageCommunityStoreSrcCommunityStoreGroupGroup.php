...
namespace DoctrineProxies\__CG__\Concrete\Package\CommunityStore\Src\CommunityStore\Group;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Group extends \Concrete\Package\CommunityStore\Src\CommunityStore\Group\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'gID', 'groupName');
        }
    ...
    public function update($groupName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'update', array($groupName));

        return parent::update($groupName);
    }
