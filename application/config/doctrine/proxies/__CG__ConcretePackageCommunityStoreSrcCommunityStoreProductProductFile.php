 ...
 */
class ProductFile extends \Concrete\Package\CommunityStore\Src\CommunityStore\Product\ProductFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'dfID', 'pID', 'product', 'dffID');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductFile $proxy) {
