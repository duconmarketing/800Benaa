...
class ShippingMethodType extends \Concrete\Package\CommunityStore\Src\CommunityStore\Shipping\Method\ShippingMethodType implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'smtID', 'smtHandle', 'smtName', 'pkgID', 'hideFromAddMenu', '' . "\0" . 'Concrete\\Package\\CommunityStore\\Src\\CommunityStore\\Shipping\\Method\\ShippingMethodType' . "\0" . 'methodTypeController');
        }
